...
import { hasRef } from './hasRef.mjs';
import { isLocalRef } from './isLocalRef.mjs';
import { pathToPointer } from './pathToPointer.mjs';
...
const bundleTarget = ({ document, path, bundleRoot = BUNDLE_ROOT, errorsRoot = ERRORS_ROOT, }, cur) => {
...
const bundle = (document, bundleRoot, errorsRoot) => {
    const takenKeys = new Set();
    const _bundle = (path, stack, cur, bundledRefInventory = {}, bundledObj = {}, errorsObj = {}) => {
...
export { BUNDLE_ROOT, ERRORS_ROOT, bundleTarget };
